...
export class TelegramNotificationService {
  ...
  status,
  '',
  `<b>Trading Mode:</b> ${cycle.tradingMode}`,
  ...
  `• Skipped trades: ${cycle.paperTrading.skippedTrades}`,
  '',
  '<b>Exchange Trading</b>',
  `• Executed orders: ${cycle.exchangeTrading.executedOrders}`,
  `• Failed orders: ${cycle.exchangeTrading.failedOrders}`,
  `• Skipped orders: ${cycle.exchangeTrading.skippedOrders}`,
  '',
